...
plt.legend()
plt.savefig("./graph12/"+str(allsys)+"_"+str(pp)+"P"+str(dp)+"DP"+str(N)+"N"+"PC1.pdf")
...
plt.axvline(x=6447/normalization, color="b",label="$p_c$")
plt.legend()
plt.savefig("./graph12/"+str(allsys)+"_"+str(pp)+"P"+str(dp)+"DP"+str(N)+"N"+"PCaux.pdf")
...
if len(L)>=2:
   ...
   plt.legend()
   plt.savefig("./graph12/"+str(allsys)+"_"+str(pp)+"P"+str(dp)+"DP"+str(N)+"N"+"REGmin.pdf")
